...
namespace EZNEW.Data.SQLite
{
    ...
    internal static class SQLiteManager
    {
        ...
        /// </summary>
        static readonly SQLiteDefaultFieldConverter DefaultFieldConverter = new SQLiteDefaultFieldConverter();

        /// <summary>
        /// Database provider type
        /// </summary>
        static readonly Type ProviderType = typeof(SQLiteProvider);
        ...
        internal static IQueryTranslator GetQueryTranslator(DataAccessContext dataAccessContext)
        {
            ...
            var translator = DataManager.GetQueryTranslator(dataAccessContext.Server.ServerType) ?? new SQLiteQueryTranslator();
